...
import com.nrohmen.kotlinconf.R
...
abstract class SessionListFragment : Fragment(), AnkoComponent<Context>{
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val viewModel = ViewModelProviders.of(this, ViewModelProviders.DefaultFactory((activity as AppCompatActivity).application))
        ...
        sessionsAdapter = SessionsAdapter(ctx, viewModel::showSessionDetails)
